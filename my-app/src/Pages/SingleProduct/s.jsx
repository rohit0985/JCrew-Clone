...
const SingleProduct = () => {
  ...
  const prod = useSelector((reduxStore)=> reduxStore.SingleProductReducer.product)
...
const addToCart = () => {
 ...
 isPresent ? 
 dispatch(updateCdata(`https://nice-tan-elk-tutu.cyclic.app/cart/${id}`,payload)) : dispatch(addCdata(`https://nice-tan-elk-tutu.cyclic.app/cart`, payload))
